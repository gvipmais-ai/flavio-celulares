...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[var(--bg-default)]">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.05] bg-center bg-no-repeat bg-[url('/images/logo-v4.png')] bg-[length:60%] mix-blend-luminosity z-0" />
